...
public class OpenAiTwilloMiddleLayerResource extends BinaryWebSocketHandler {
  ...
  public OpenAiTwilloMiddleLayerResource() {
    super();
        ...
        try {
          ...
          if ("response.function_call_arguments.done".equals(eventType)) {
            ...
            try {
              ...
              sendFunctionCallResult("Order is placed on 23 feb. its pending for payment", callId);
            } catch (Exception e) {
  ...
  private String getAssistantResponse(JSONObject functionCallArgs) {
    return null;
  }
